...
//        self.label7.text = self.str7 + ":"
    ...
    @IBAction func startRealtimeData(_ sender: Any) {
        SLPLTcpManager.sharedInstance()?.startRealTimeData(withDeviceID: self.deviceID, deviceType: SLPDeviceTypes.SDC100, leftRight:Int32(UserDefaults.standard.string(forKey: "leftRight")!)!, timeout: 10.0, callback: { (status: SLPDataTransferStatus, data: Any?) in
    ...
    @IBAction func stopRealtimeData(_ sender: Any) {
        ...
        SLPLTcpManager.sharedInstance()?.stopRealTimeData(withDeviceID: deviceID, deviceType: SLPDeviceTypes.SDC100,leftRight: Int32(UserDefaults.standard.string(forKey: "leftRight")!)!, timeout: 10, callback: { (status: SLPDataTransferStatus, data: Any?) in
            if status == SLPDataTransferStatus.succeed
            {
    ...
    @IBAction func stopMonitor(_ sender: Any) {
        ...
        SLPLTcpManager.sharedInstance()?.getCollectionStatus(withDeviceID: deviceID, deviceType: SLPDeviceTypes.SDC100,leftRight:Int32(UserDefaults.standard.string(forKey: "leftRight")!)!, timeout: 0, callback: { [self] (status: SLPDataTransferStatus, data: Any?) in
            let dID = deviceID
            if status == SLPDataTransferStatus.succeed {
                ...
                SLPLTcpManager.sharedInstance()?.stopCollection(withDeviceID: dID, deviceType: SLPDeviceTypes.SDC100,leftRight:Int32(UserDefaults.standard.string(forKey: "leftRight")!)!, userID: userid!, timeStamp:time, timeout: 10, callback: { (status: SLPDataTransferStatus, data: Any?) in
    ...
    @IBAction func checkOnlineStatus(_ sender: Any) {
        ...
        SLPLTcpManager.sharedInstance()?.publicGetOnlineStatus(withDeviceID: deviceID, deviceType: SLPDeviceTypes.SDC100, timeout: 15.0, callback: { (status: SLPDataTransferStatus, data: Any?) in
            if status == SLPDataTransferStatus.succeed
            {
    ...
    @IBAction func checkMonitorStatus(_ sender: Any) {
        SLPLTcpManager.sharedInstance()?.getSleepStatus(withDeviceID: deviceID, deviceType: SLPDeviceTypes.SDC100,leftRight: Int32(UserDefaults.standard.string(forKey: "leftRight")!)!, timeout: 10.0, callback: { (status: SLPDataTransferStatus, data: Any?)in
            if status == SLPDataTransferStatus.succeed
            {
